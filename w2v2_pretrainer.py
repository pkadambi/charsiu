...
class ModelArguments:
    ...
    model_name_or_path: str = field(
        ...
        default='patrickvonplaten/wav2vec2-base-libri-100h',
    )
...
class DataTrainingArguments:
    ...
    dataset_name: str = field(
        default="timit_asr", metadata={"help": "The name of the dataset to use (via the datasets library)."}
    )
...
training_args.output_dir = './models_test'
